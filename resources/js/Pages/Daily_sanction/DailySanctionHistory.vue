          ...
          <div class="page-inner allinsideform">
            <div class="page-header">
              ...
              <ul class="breadcrumbs mb-3">
                ...
                <li class="nav-item">
                  <a href="#">Daily Sanction History</a>
                </li>
              </ul>
              ...
              <div class="col-md-12">
                <div class="card">
                  <div class="card-header">
                    <div class="card-title">Daily Sanction History</div>
                  </div>
                  <div class="card-body">
                    <!-- Flash Message -->
                    ...
                    <div v-if="isLoading" class="text-center py-4">
                      ...
                      <p class="mt-2 text-muted">Loading daily sanction history...</p>
                    </div>
                        ...
                        <table class="table table-bordered table-head-bg-primary">
                                ...
                                <table class="table table-sm mb-0">
                                  ...
                                  <tbody>
                                    ...
                                    <tr v-if="!item.budget_heads || item.budget_heads.length === 0">
                                      <td colspan="3" class="text-center text-muted">No budget heads available</td>
                                    </tr>
                                  </tbody>
                                </table>
                              </div>
                          ...
                          <tr v-if="historyData.length === 0">
                            <td colspan="10" class="text-center text-muted py-4">
                              ...
                              No daily sanction history available
                            </td>
                          </tr>
                          </tbody>
                        </table>
