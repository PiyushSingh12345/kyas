                ...
                <div class="card-body">
                  <form @submit.prevent="submitForm">
                    <div class="row">
                      ...
                      <div class="col-md-6 col-lg-4">
                        <div class="form-group">
                          <label for="ut">UT <span class="text-danger">*</span></label>
                          <select 
                            class="form-select" 
                            id="ut" 
                            v-model="formData.ut"
...
const submitForm = async () => {
  ...
  if (!formData.value.sanctionNumber || !formData.value.date || !formData.value.budgetHead || 
      ...
      !formData.value.amount || !formData.value.ut) {
  ...
  try {
    ...
    const submitData = {
      ...
      ut: formData.value.ut
    }

    const response = await fetch('/api/agency-release-loa', {
      method: 'POST',
      headers: {
